...
if __name__ == '__main__':
    ...
    '''
    pred = np.array([
        [-33.76, 43.99, 61.65, 43.88, 0],
        [-51.96, 19.61, 61.65, 43.88, 0],
        [-88.25, 7.33, 61.65, 43.88, 0],
        [-109.89, -13.51, 61.65, 43.88, 0],
        [-60.44, 14.7, 61.65, 43.88, 0],
        [0, 0, 61.65, 43.88, 0]
    ])

    gt = np.array([
        [-37.9, 19.33, 64.09, 48.89, 0],
        [-75.68, 12.1, 64.09, 48.89, 0],
        [-97.17, -8.95, 64.09, 48.89, 0],
        [-51.24, -29.18, 40.65, 42.58, 0],
        [0, -1, 58.42, 40.32, 0],
    ])
